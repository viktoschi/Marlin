 ...
 */
#define E0_AUTO_FAN_PIN 7                                  // Viktoschi
...
// @section bltouch
   ...
   */
  #define BLTOUCH_SET_5V_MODE                              // Viktoschi
   ...
   */
  #define BLTOUCH_HS_MODE true                             // Viktoschi
 ...
 */
#define Z_STEPPER_AUTO_ALIGN                               // Viktoschi
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING                            // Viktoschi
...
//#define LCD_BACKLIGHT_TIMEOUT 30 // (s) Timeout before turning off the backlight
  ...
  #define LCD_SET_PROGRESS_MANUALLY                        // Viktoschi
...
// LCD Print Progress options
  ...
  #define LONG_FILENAME_HOST_SUPPORT      // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'        // Viktoschi
  #define LONG_FILENAME_WRITE_SUPPORT     // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol                    // Viktoschi
  ...
  #define AUTO_REPORT_SD_STATUS           // Auto-report media status with 'M27 S<seconds>'        // Viktoschi
   ...
   */
  #define SDCARD_CONNECTION ONBOARD                        // Viktoschi
...
#define BABYSTEPPING                                       // Viktoschi
  ...
  #define BABYSTEP_ZPROBE_OFFSET            // Combine M851 Z and Babystepping           // Viktoschi
 ...
 */
#define LIN_ADVANCE                                        // Viktoschi
#if ENABLED(LIN_ADVANCE)
  //#define EXTRA_LIN_ADVANCE_K // Enable for second linear advance constants
  #define LIN_ADVANCE_K 0.13    // Unit: mm compression per 1mm/s extruder speed         // Viktoschi
...
#define TX_BUFFER_SIZE 16                                  // Viktoschi
 ...
 */
#define EMERGENCY_PARSER                                   // Viktoschi
...
#define SERIAL_FLOAT_PRECISION 4                           // Viktoschi
 ...
 */
#define ADVANCED_PAUSE_FEATURE                             // Viktoschi
  ...
  #define PARK_HEAD_ON_PAUSE                      // Park the nozzle during pause and filament change.                                     // Viktoschi
  #define HOME_BEFORE_FILAMENT_CHANGE             // If needed, home before parking for filament change                                    // Viktoschi

  #define FILAMENT_LOAD_UNLOAD_GCODES             // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.          // Viktoschi
 ...
 */
#define AUTO_REPORT_TEMPERATURES                           // Viktoschi
 ...
 */
#define AUTO_REPORT_POSITION                               // Viktoschi

/**
 * Include capabilities in M115 output
 */
#define EXTENDED_CAPABILITIES_REPORT                       // Viktoschi
#if ENABLED(EXTENDED_CAPABILITIES_REPORT)
  #define M115_GEOMETRY_REPORT                             // Viktoschi
#endif
...
#define M114_DETAIL           // Use 'M114` for details to check planner calculations              // Viktoschi
//#define M114_REALTIME       // Real current position based on forward kinematics
//#define M114_LEGACY         // M114 used to synchronize on every call. Enable if needed.

#define REPORT_FAN_CHANGE     // Report the new fan speed when changed by M106 (and others)        // Viktoschi
 ...
 */
#define HOST_ACTION_COMMANDS                               // Viktoschi
#if ENABLED(HOST_ACTION_COMMANDS)
  //#define HOST_PAUSE_M76                // Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT             // Initiate host prompts to get user feedback                      // Viktoschi
  #if ENABLED(HOST_PROMPT_SUPPORT)
    #define HOST_STATUS_NOTIFICATIONS     // Send some status messages to the host as notifications          // Viktoschi
  #endif
 ...
 */
#define CANCEL_OBJECTS                                     // Viktoschi
